...
public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
    ...
    View view = inflater.inflate(R.layout.fragment_search_library_, container, false);

    svsearchBooks = view.findViewById(R.id.et_library_searchFrg_SearchBooks);
    tvNoBooksAvailable = view.findViewById(R.id.tv_library_searchFrg_BookNotAvailable);
    lvBooks = view.findViewById(R.id.gvLibrary_searchFrag_Books);
